...
from ec2 import get_service_status, set_service_status
...
def on_intent(intent_request, session):
    ...
    card_title = "Tennis Cloud Manager"
    session_attributes = {}
    reprompt_text = ""
...
def handle_session_end_request():
    card_title = "Tennis Cloud Manager"
    speech_output = "Thank you for using the Tennis Alexa Cloud Manager skill. See you next time!"
    should_end_session = True
...
def get_welcome_response():
    session_attributes = {}
    card_title = "Tennis Cloud Manager"
    speech_output = "Welcome to Tennis' Alexa cloud manager skill. " \
                    "You can ask me for server status, " \
                    "or ask me to turn servers on or off."
